 ...
 * @since  1.0
 */
class LingoModelManifestTable extends JModelAdmin
{
	/**
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'ManifestTable', $prefix = 'LingoTable', $config = array())
	{
	...
	public function getItem($pk = null)
	{
		...
		{
			/* @var $translatableFieldsModel LingoModelManifestFields */
			$translatableFieldsModel = LingoHelper::getModel('ManifestFields');
	...
	{
		/* @var $translatableFieldModel LingoModelManifestField */
		$translatableFieldModel = LingoHelper::getModel('ManifestField');
	...
	public function save($data)
	{
		...
		if (parent::save($data))
		{
			...
			/* @var $table LingoTableManifestTable */
			$table = $this->getTable();
	...
	public function getDatabaseTableColumns($tableData)
	{
		...
		/* @var $manifestFieldModel LingoModelManifestField */
		$manifestFieldModel = LingoHelper::getModel('ManifestField');
