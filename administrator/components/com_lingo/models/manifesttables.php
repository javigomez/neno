 ...
 * @since  1.0
 */
class LingoModelManifestTables extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	public function getItems()
	{
		...
		/* @var $manifestFieldsModel LingoModelManifestFields */
		$manifestFieldsModel = LingoHelper::getModel('ManifestFields');
	...
	public function deleteUnusedTables(array $tableAdded)
	{
		...
		/* @var $manifestTableTable LingoTableManifestTable */
		$manifestTableTable = $this->getTable('ManifestTable', 'LingoTable');
