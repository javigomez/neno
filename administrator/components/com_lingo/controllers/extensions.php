 ...
 * @since  1.0
 */
class LingoControllerExtensions extends JControllerAdmin
{
	/**
	...
	public function import()
	{
		...
		/* @var $extensionModel LingoModelExtension */
		...
		$this->setRedirect(JRoute::_('index.php?option=com_lingo&view=extensions', false));
	}
}
