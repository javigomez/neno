...
<form action="<?php echo JRoute::_('index.php?option=com_lingo&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="translation-form" class="form-validate">
