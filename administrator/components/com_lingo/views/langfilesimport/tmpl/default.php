...
<?php if ($this->changes_pending): ?>
    ...
    <div class="alert alert-warning"><span class="icon-warning-2"></span> <?php echo JText::_('COM_LINGO_LANGFILES_IMPORT_ALERT_CHANGES_PENDING'); ?></div>
<?php else: ?>
    <!-- show all ok -->
    <div class="alert alert-success"><span class="icon-ok"></span> <?php echo JText::_('COM_LINGO_LANGFILES_IMPORT_ALERT_NO_CHANGES_PENDING'); ?></div>
<?php endif; ?>    
...
<?php if ($change_count): ?>
    ...
    <div class="alert alert-warning"><span class="icon-warning-2"></span> <?php echo JText::sprintf('COM_LINGO_LANGFILES_IMPORT_ALERT_CHANGES_IN_TARGET', $change_count); ?></div>
<?php endif; ?>    
                ...
                <div class="row-striped">
                    <div class="row-fluid">
                        ...
                        <strong class="row-title">
                            <span class="badge <?php echo ($change_count > 0) ? 'badge-important' : ''; ?>"><?php echo $change_count; ?></span>
