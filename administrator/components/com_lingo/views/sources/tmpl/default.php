...
<form action="<?php echo JRoute::_('index.php?option=com_lingo&view=sources'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="sourceList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_lingo&task=source.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->string); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->string); ?>
				<?php endif; ?>
				</td>
				<td>
				...
				<td>
					...
					<?php echo $item->time_changed; ?>
				</td>
				<td>

					<?php echo $item->time_deleted; ?>
				</td>
				<td>
