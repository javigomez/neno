...
/**
 * NenoModelSource class
 *
 * @since  1.0
 */
class NenoModelSource extends JModelAdmin
{
	/**
	 ...
	 * @since    1.0
	 */
	public function getTable($type = 'Source', $prefix = 'NenoTable', $config = array())
	{
	 ...
	 *
	 * @param   array|integer  $pk  The id of the primary key.
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__neno_langfile_source');
				$max             = $db->loadResult();
