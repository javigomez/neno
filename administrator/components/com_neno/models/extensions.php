...
class NenoModelExtensions extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query
			...
			->where('type IN (' . implode(',', array_map(array( 'NenoModelExtensions', 'escapeString' ), self::$extensionTypeAllowed)) . ')')
			->order('name');
	...
	function getComponentTables($componentName)
	{
		...
		$manifestTableModel = NenoHelper::getModel('ManifestTable');
	 ...
	 * @return array
	 */
	public function getExtensionsMarkedAsTranslatable()
	{
		$db = JFactory::getDbo();
		...
		$manifestTablesModel = NenoHelper::getModel('ManifestTables');
