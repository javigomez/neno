 ...
 * @since  1.0
 */
class NenoTableSource extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct(NenoContentElementLangfileSource::getDbTable(), 'id', $db);
	}
	...
	public function bind($src, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_neno.source.' . $src['id']))
		{
			$actions         = JFactory::getACL()->getActions('com_neno', 'source');
			$default_actions = JFactory::getACL()->getAssetRules('com_neno.source.' . $src['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_neno.source.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_neno');
