 ...
 * @since  1.0
 */
class NenoTableTranslation extends JTable
{
	/**
	 * Constructor
	 *
	...
	public function bind($src, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_neno.translation.' . $src['id']))
		{
			$actions         = JFactory::getACL()->getActions('com_neno', 'translation');
			$default_actions = JFactory::getACL()->getAssetRules('com_neno.translation.' . $src['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_neno.translation.' . (int) $this->$k;
	}
