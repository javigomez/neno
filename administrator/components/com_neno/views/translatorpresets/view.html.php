...
/**
 * NenoViewSources class
 *
 * @since  1.0
 */
class NenoViewTranslatorPresets extends JViewLegacy
{
	/**
	 * @var array
	 */
	...
	protected function addToolbar()
	{
		...
		$canDo = NenoHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_NENO_TITLE_SOURCES'), 'sources.png');
