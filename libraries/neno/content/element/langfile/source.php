...
/**
 * Class NenoContentElementLangFileSource
 *
 * @since  1.0
 */
class NenoContentElementLangfileSource extends NenoContentElementLangfile
{
	/**
	 * @var string
	 */
	...
	public static function loadSourceLanguageStrings($language)
	{
		...
		{
			$sourceLanguageStrings[$arrayKey] = new NenoContentElementLangfileSource($sourceLanguageStrings[$arrayKeys]);
		}
